    ...
    <div class = "card employee-card">
        ...
        <div class = "card-body">
            <ul class = "list-group">
                ...
                <li class="text-danger list-group-item">GitHub: <a href="https://github.com/${empEngineer[i].gitHub}" target="_blank" rel="noopener noreferrer">${empEngineer[i].gitHub}</a></li>
            </ul>
        </div>
    </div>
    </div>`
        ...
        <div class = "card employee-card">
            ...
            <div class = "card-body">
                <ul class = "list-group">
                    ...
                    <li class="text-danger list-group-item">School: ${empIntern[i].school}</li>
                </ul>
            </div>
        </div>
        </div>`
        ...
        <div class = "card employee-card">
            ...
            <div class = "card-body">
                <ul class = "list-group">
                    ...
                    <li class="text-danger list-group-item">Office number: ${empManager[i].offNum}</li>
                </ul>
            </div>
        </div>
        </div>`
